export default function ProcessSection() {
  return <section className="max-w-xl w-100 d-flex flex-column justify-items-center mx-auto text-center text-white font-raleway py-10">
    <div className="d-flex flex-column justify-items-center mx-auto ">
      ...
      <h5 className="pt-1">Our approach is <span className="text-secondary-muted font-bold">Iterative</span></h5>
      ...
      <div>
        <div className="d-flex gap-2 position-relative">
          <div className="hex bg-secondary-muted text-secondary-muted">
            ...
            <div className="info-card bg-white text-black top-left">
              <h6>Discovery</h6>
          ...
          <div className="hex bg-white text-white">
            ...
            <div className="info-card bg-black text-white top-right">
              <h6>Design</h6>
        ...
        <div style={{ paddingLeft: "56px" }} className="d-flex gap-2 mt-2">
          <div className="hex bg-white text-white">
            ...
            <div className="info-card text-white bg-black bottom-left">
              <h6>Development</h6>
          ...
          <div className="hex bg-secondary-muted text-secondary-muted">
            ...
            <div className="info-card bg-white text-black bottom-right">
              <h6>Delivery</h6>
              <p>Businesses should deliver value to all stakeholders, not just shareholders, taking care of employees, vendors, and customers alike.</p>
            </div>
          </div>
